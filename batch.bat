...
load --init $HOME/myexpos/expl/expl_progs/login.xsm
load --idle $HOME/myexpos/expl/expl_progs/idle.xsm
load --shell $HOME/myexpos/expl/expl_progs/extended_shell.xsm
...
load --int=12 $HOME/myexpos/spl/spl_progs/INT_12.xsm
...
load --int=16 $HOME/myexpos/spl/spl_progs/INT_16.xsm
load --int=17 $HOME/myexpos/spl/spl_progs/INT_17.xsm
...
load --exec $HOME/myexpos/expl/expl_progs/lu.xsm
load --exec $HOME/myexpos/expl/expl_progs/ru.xsm
...
load --exec $HOME/myexpos/expl/expl_progs/s27_a4.xsm
load --exec $HOME/myexpos/expl/expl_progs/pgm2.xsm
